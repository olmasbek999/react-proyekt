...
function Katolog() {
  return (
    <>
      <header className="bg-green-600 flex justify-between items-center gap-[1] p-[10px]">
      ...
      <div className="flex  flex-wrap justify-center gap-20 ">
        <div className="flex flex-col items-center gap-[10px], p-[15px],  t-10 bg-[#f7f7f9] rounded-lg p-9">
          <img
          ...
          <h1>qazi</h1>
          <h4>300000so'm</h4>
          <button className="p-[10px] rounded-lg border-3 cursor-pointer bg-[#fff]">
            <Link to="/sale">Sotib olish</Link>
          </button>
        </div>
        <div className="flex flex-col items-center gap-[10px] p-[15px]  t-10  bg-[#f7f7f9] rounded-lg">
          <img
            className="w-[180px] h-[180px] object-cover rounded-lg"
